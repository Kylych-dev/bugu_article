        ...
        if serializer.is_valid():
            try:
                ...
                data = {
                    ...
                    'role': 'author' if hasattr(user, 'author_profile') else 'subscriber'
                }
                return Response(
                    data=data,
...
class AuthenticationView(viewsets.ViewSet):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'refresh_token': openapi.Schema(type=openapi.TYPE_STRING, description='Refresh Token пользователя'),
            },
        ),
        responses={
